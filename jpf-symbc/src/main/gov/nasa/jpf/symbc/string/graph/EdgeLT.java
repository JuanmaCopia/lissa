...
public class EdgeLT implements Edge {

	Vertex v1, v2;
	final String name;
	
	public EdgeLT (String name, Vertex v1, Vertex v2) {
		this.v1 = v1;
		this.v2 = v2;
		this.name = name;
	}
	...
	public Edge cloneAndSwapVertices(Map<Vertex, Vertex> oldToNew) {
		return new EdgeLT(name, oldToNew.get(v1), oldToNew.get(v2));
	}
}
