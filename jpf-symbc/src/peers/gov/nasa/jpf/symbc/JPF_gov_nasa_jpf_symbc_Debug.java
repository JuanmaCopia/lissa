...
public class JPF_gov_nasa_jpf_symbc_Debug extends NativePeer {
     ...
     * heap h such that all objects in h
     ...
     * include all non-reference fields which
     * are integers. for now, state is represented by the concatenation of all
     * non-reference integer fields
     */
     ...
     * implementation wrt isZero() observer
     * method of IncDec.java Hence it works only with IncDecDriverAbstraction.java
     * Find out how to invoke observer
